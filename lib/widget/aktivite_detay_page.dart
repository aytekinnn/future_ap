...
class KonumText extends StatelessWidget {
  const KonumText({super.key});
...
class _GoogleMapsState extends State<GoogleMaps> {
  ...
  final LatLng _center = const LatLng(41.265636, 36.366974);
        ...
        children: [
          ...
          Padding(
            ...
            child: FloatingActionButton.extended(
              ...
              icon: const Icon(ADIcon.location),
            ),
          ),
        ],
      ),
...
class Sldiers extends StatefulWidget {
  const Sldiers({super.key});

  @override
  State<Sldiers> createState() => _SldiersState();
}

class _SldiersState extends State<Sldiers> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: [
            ...
            GestureDetector(
              ...
              child: Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image:
                        AssetImage("assets/images/aktivite/yoga-detay-2.jpg"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
